...
export function Hero() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-slate-900 pt-24 md:pt-28">
      {/* ThreeJS Animation Background - Make sure z-index is appropriate */}
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('/images/world-trade-bg.jpg')] bg-cover bg-center opacity-30" />
      </div>
