  ...
  return (
    <section id="zkproofs" className="w-full py-20 bg-white">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight">ZK Origin Proofs</h2>
          <p className="mt-4 text-slate-600 md:text-lg max-w-3xl mx-auto">
            Zero-knowledge proofs allow exporters to verify product origins without revealing sensitive business information.
          </p>
        </motion.div>
